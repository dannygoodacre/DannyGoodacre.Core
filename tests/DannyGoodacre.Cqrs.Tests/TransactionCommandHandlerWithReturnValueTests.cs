...
public sealed class TransactionCommandHandlerWithReturnValueTests : TransactionCommandHandlerTestBase<TransactionCommandHandlerWithReturnValueTests.TestTransactionCommandHandler, int>
{
    ...
    private static Func<TestCommand, CancellationToken, Task<IResult<int>>> _internalExecuteAsync = null!;
    ...
    public void SetUp()
    {
        ...
        _internalExecuteAsync = (_, _) => Task.FromResult<IResult<int>>(new Success<int>(TestResultValue));
    ...
    public async Task WhenNotSuccessful_ShouldReturnResult()
    {
        ...
        _internalExecuteAsync = (_, _) => Task.FromResult<IResult<int>>(new InternalError<int>(testError));
    ...
    public async Task WhenCanceledWhilePersistingChanges_ShouldReturnCanceled()
    {
        ...
        TransactionUnitMock
            .Setup(x => x.ExecuteInTransactionAsync(
                It.IsAny<Func<CancellationToken, Task<IResult<int>>>>(),
